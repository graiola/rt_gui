...
public:
  ...
  bool update(rt_gui_msgs::Void::Request& req, rt_gui_msgs::Void::Response& res)
  {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class IntHandler : public InterfaceHandler<rt_gui_msgs::Int,int>
{
...
public:
  ...
  IntHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::Int,int>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class DoubleHandler : public InterfaceHandler<rt_gui_msgs::Double,double>
{
...
public:
  ...
  DoubleHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::Double,double>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class BoolHandler : public InterfaceHandler<rt_gui_msgs::Bool,bool>
{
...
public:
  ...
  BoolHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::Bool,bool>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class ListHandler : public InterfaceHandler<rt_gui_msgs::List,std::string>
{
...
public:
  ...
  ListHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::List,std::string>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CheckHandler : public VectorHandler<rt_gui_msgs::Check,bool>
{
...
public:
  ...
  CheckHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :VectorHandler<rt_gui_msgs::Check,bool>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class TextHandler : public InterfaceHandler<rt_gui_msgs::Text,std::string>
{
...
public:
  ...
  TextHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::Text,std::string>(node,add_srv,update_srv,feedback_srv,server_name,client_name) {}
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class LabelHandler : public InterfaceHandler<rt_gui_msgs::Text,std::string>
{
...
public:
  ...
  LabelHandler(ros::NodeHandle& node, std::string add_srv, std::string update_srv, std::string feedback_srv, std::string server_name, std::string client_name)
    :InterfaceHandler<rt_gui_msgs::Text,std::string>(node,add_srv,update_srv,feedback_srv,server_name,client_name,true) {}
};
